...
def prepare_data(df):
  ...
  Returns:
      tuple: It is used to return the dependent and Independent Variables
  """
  logging.info("prepraing the data by segragating the dependent and independent varable")
  X = df.drop("y", axis=1)
...
def save_model(model, filename):
  """This method used to save the Trained Model
...
def save_plot(df, file_name, model):
  ...
  logging.info("saved the plot {plotPath}")